...
- It must use as input at most a D-pad (up, down, left, right) and 4 action keys; the hardware bindings are left up to you (e.g. you may choose to map the D-pad inputs to WASD)
